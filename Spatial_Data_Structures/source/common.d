...
//     auto points = [Point!2([1,2]), Point!2([-2, 5]),Point!2([-5,-5])];
//     auto aabb = boundingBox(points);
//     // assert(aabb.min == Point!2([-2, 2]));
//     // assert(aabb.max == Point!2([1, 5]));

//     auto closestPoint = closest(aabb,Point!2([5,5]));
//     writeln("\n --Closest Test--");
//     writeln("Closest Point = ",closestPoint);

//     auto point = [Point!2([1,1])];
//     auto aabb2 = boundingBox(point);
//     auto closestTest = closest(aabb2,Point!2([0,0]));
//     writeln("Closest Test = ",closestTest);
// }
...
//     writeln("\n\n\n\n indices between ", bottomLeft, " and ", topRight);
